...
{
    FILE *file;
    int i1,n=0,k,j1=0,userl,userc,passl,passc,backupc;
    char /**keyuserp[7],*/keyuser[7]={'S','a','n','d','e','s','h'},/**keypasswordp[10],*/user[20],password[30];
    char keypassword[11] = {'3','7','9','1','S','a','n','d','e','s','H'},backup[5] = {'q','V','t','<','o'};
    ...
    case 1:
        {
            ...
            //while(fread(&rock,sizeof(rock),1,file)==1)
            {
                for(int k=0;k<5;k++)
                {

...
void Binary_to_Decimal(long int);
void Binary_to_Octal(long int);
void Binary_to_Hexadecimal(long int);
void Decimal_to_Binary(long int);
void Decimal_to_Octal(long int);
void Decimal_to_Hexadecimal(long int);
void Octal_to_Binary(long int);
void Octal_to_Decimal(long int);
void Octal_to_Hexadecimal(long int);
...
void Binary_to_Decimal(long int bin)
{
...
void Binary_to_Octal(long int bin)
{
...
void Binary_to_Hexadecimal(long int bin)
{
...
void Decimal_to_Binary(long int dec)
{
...
void Decimal_to_Octal(long int dec)
{
    int remainder[50],x,length=0;
    x=0;
    do
...
void Decimal_to_Hexadecimal(long int dec)
{
    int remainder[50],x,length=0;
    x=0;
    do
...
void Octal_to_Binary(long int oct)
{
...
void Octal_to_Decimal(long int oct)
{
...
void Octal_to_Hexadecimal(long int oct)
{
